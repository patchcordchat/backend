...
Для удобного тестирования эндпоинтов доступна официальная коллекция Postman. Вы можете импортировать её в свой клиент:

👉 [Ссылка на коллекцию Patchcord в Postman](https://www.postman.com/patchcord/patchcord)
